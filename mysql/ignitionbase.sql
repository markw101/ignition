...
(5,'2023-11-16 11:18:42','2026-04-24 15:36:37',NULL,3,'About','en','about','<div class=\"container\"><div class=\"row\"> <div class=\"mx-auto\" style=\"margin-top:0px; margin-left: 25px; margin-right: 25px; margin-bottom:40px\"><h1>ABOUT</h1><br>\r\nAccess and change this page by logging in and going to the menu for Tools->Site Pages\r\n\r\nHere is an example of using the COMMAND___lang HTML inline directive to integrate your Help language files into site pages:<br><a href=\"/content/help\"><u>Help Text</u></a>\r\n\r\nCheck out the Site Page \"Help\" for the inline directive code example (Tools->Site Pages->Help).\r\n\r\n</div></div></div>','','',1),
(6,'2023-11-16 11:19:12','2026-04-24 15:36:37',NULL,3,'Acerca De','es','acercade','<div class=\"container\"><div class=\"row\"> <div class=\"mx-auto\" style=\"margin-top:0px; margin-left: 25px; margin-right: 25px; margin-bottom:40px\"><h1>ACERCA DE</h1><br>\r\nPara acceder a esta página y modificarla, inicie sesión y vaya al menú Herramientas->Páginas del sitio\r\n\r\nAquí hay un ejemplo del uso de la directiva HTML en línea COMMAND___lang para integrar sus archivos de idioma de Ayuda en las páginas del sitio:<br><a href=\"/content/help\"><u>Texto de Ayuda</u></a>\r\n\r\nConsulte la página del sitio «Ayuda» para ver el ejemplo de código de la directiva en línea (Herramientas->Páginas del sitio->Ayuda).\r\n\r\n</div></div></div>\r\n\r\nTraducción realizada con la versión gratuita del traductor DeepL.com','','',1),
(7,'2023-11-16 11:21:24','2023-11-16 04:47:13',NULL,2,'Ayuda','es','ayuda','','','',1),
(8,'2026-03-16 11:18:14','2026-03-16 04:18:14',NULL,4,'Help','en','help','<div class=\"container\"><div class=\"row\"> <div class=\"mx-auto\" style=\"margin-top:0px; margin-left: 25px; margin-right: 25px; margin-bottom:40px\"><h1>___COMMAND___lang(\'base.help\');</h1>\r\n___COMMAND___lang(\'help.general\');\r\n</div></div></div>','','',1),
(10,'2026-04-24 22:35:48','2026-04-24 15:36:37',NULL,3,'关于','zh','aboutzh','<div class=\"container\"><div class=\"row\"> <div class=\"mx-auto\" style=\"margin-top:0px; margin-left: 25px; margin-right: 25px; margin-bottom:40px\"><h1>关于</h1><br>\r\n登录后，前往“工具”->“网站页面”菜单，即可访问并修改此页面\r\n\r\n以下是使用 COMMAND___lang HTML 内联指令将帮助语言文件集成到网站页面中的示例：<br><a href=\"/content/help\"><u>帮助文本</u></a>\r\n\r\n请查看网站页面“帮助”以获取内联指令代码示例（工具->网站页面->帮助）。\r\n\r\n</div></div></div>','','',1);
...
-- Dump completed on 2026-04-24 15:41:30
