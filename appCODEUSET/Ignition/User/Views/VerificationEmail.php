...
echo lang('base.resend_verification') . '</div>';

echo '<div class=panel-body style="width: 100%; background-color:#1b2433; border-color:#222e3e; color:#ffffffff; font-size:20px">';

echo lang('base.resend_verification');
br();
echo lang('base.email_verification');
br();
$form->IText('user_email', ['autofocus' => TRUE]);
$form->IFormSubmit(lang('base.send'), 'class=buttonClass');
$form->IFormClose();
