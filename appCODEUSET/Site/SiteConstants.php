...
*********************************************************************/
    ...
    $editMode = FALSE;
	define("SERVERBASENAME", "myignition.com");
	...
	$GLOBALS['LANGCODE'] = "";
	define("AUTOLANG", FALSE);		     // if true, will determine language based on URL otherwise SiteConfig->userLocale 
	...
	define("DEFAULTDBGROUP", "ignitionbase");  // default db table group, STATIC
